...
class ExamMarkDetailsPage extends StatefulWidget {
  ...
  const ExamMarkDetailsPage({super.key,required this.examTermId, required this.examTerm});
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            /// 🔵 Top Section
            Container(
              padding: const EdgeInsets.only(top: 50, left: 1, right: 16, bottom: 20),
              color: appBlueTheme,
              child: Column(
                children: [
                  /// AppBar Row
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    InfoItem(title: "Class", value: AppData.studentStdId!),
                                     InfoItem(title: "Admission No", value: AppData.admissionNo!),
                                     InfoItem(title: "Academic Year", value: AppData.accYear!),
                                  ],
                                )
                              ],
                            ),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Subject",style: TextStyle(color:appBlueFont,fontWeight: FontWeight.bold,fontSize: 11),),
                   Text("Mark Obtained",style:TextStyle(color:appBlueFont,fontWeight: FontWeight.bold,fontSize: 11),),
                   Text("Total Mark",style: TextStyle(color:appBlueFont,fontWeight: FontWeight.bold,fontSize: 11),),
                   Text("Grade",style:TextStyle(color:appBlueFont,fontWeight: FontWeight.bold,fontSize: 11),),
                ],
              ),
            ),
...
class MarkRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      Row(
        children: [
          Expanded(flex: 2, child: Text("${subject}", style: TextStyle(fontSize: 13),)),
