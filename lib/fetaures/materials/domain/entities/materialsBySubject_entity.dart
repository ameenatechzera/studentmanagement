...
class MaterialList extends Equatable {
  ...
  @override
  List<Object?> get props => [
    materialId, staffId, employeeName, accYear, standardId, standard, divisionId, division, subjectId, subjectName, material, branchId, createdDate, createdUser, modifiedDate, modifiedUser, documentName, notes, link, favorite, ];
}
