              ...
              BlocConsumer<LoginCubit, LoginState>(
                listener: (context, state) async {
                  if (state is FetchPaymentGatewayDetailsSuccess) {
                    ...
                    await sharedPrefHelper.setSaltKey(state.gatewayDetails.data.first.saltkey);

                    AppData.merchantKey =state.gatewayDetails.data.first.merchantKey;
                    AppData.saltKey = state.gatewayDetails.data.first.saltkey;
                    print('state.gatewayDetails.data.first ${state.gatewayDetails.data.first}');
