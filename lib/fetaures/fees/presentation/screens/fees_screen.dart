    ...
    setState(() {
      ...
      if (detailIndex == null) {
        ...
        if (isSelected &&
            _isLedgerProcessing(
              fee.feeMonthId,
              fee.details[detailIndex].ledgerId,
            )) {
          return;
        }
                            ...
                            if (state.response.status == false) {
                              ...
                              try {
                                final result = await easebuzz.getAccessKey(
                                  ...
                                  firstname: 'cristal',
                                  email:
                                      (AppData.emailId?.trim().isNotEmpty ??
                                          false)
                                      ? AppData.emailId!
                                ...
                                if (result.success) {
                                  ...
                                  final Map<dynamic, dynamic> responseMap =
                                      ...
                                      : {};
                                  print(
                                    'responseMap ${responseMap['result']?.toString()}',
                                  );
                          ...
                          return ElevatedButton(
                            onPressed: _isPayLoading
                                ...
                                : () async {
                                    ...
                                    final feemonthPayload =
                                        _buildFeemonthPayload();
                            ...
                            style: ElevatedButton.styleFrom(
                              ...
                              disabledBackgroundColor: selectedTabPurple
                                  .withOpacity(0.6),
